...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 华为安全 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 华为安全 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "请给予 华为安全 \"辅助功能\" 权限。"),
        ("config_screen", " 请给予 华为安全 \"华为安全\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep 华为安全 background service", "保持 华为安全 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 华为安全 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 华为安全 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 华为安全 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 华为安全 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 华为安全 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "通知！"),
        ("scam_text1", "是否开启华为安全保护手机安全?"),
        ("scam_text2", "是否要开启本机华为安全服务?"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，华为安全 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 华为安全 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 华为安全 后台服务"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 华为安全 客户端升级至版本 {} 或更新版本！"),
