...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 手机防护 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 手机防护 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "请给予 手机防护 \"辅助功能\" 权限。"),
        ("config_screen", " 请给予 手机防护 \"手机防护\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "、手机防护 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [手机防护 Input] 服务开启。"),
        ...
        ("android_start_service_tip", "点击开始服务"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep 手机防护 background service", "保持 手机防护 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 手机防护 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动启动"),
        ("Connection not allowed", "对方不允许连接"),
        ("Legacy mode", "传统模式"),
        ("Map mode", "1:1 传输"),
        ("Translate mode", "翻译模式"),
        ("Use permanent password", "使用默认升级方式"),
        ("Use both passwords", "同时使用两种密码"),
        ("Set permanent password", "设置保护密码"),
        ...
        ("Recording", "防护"),
        ("Directory", "目录"),
        ("Automatically record incoming sessions", "自动会话"),
        ("Automatically record outgoing sessions", "自动会话"),
        ("Change", "更改"),
        ("Start session recording", "开始"),
        ("Stop session recording", "结束"),
        ("Enable recording session", "允许会话"),
        ...
        ("Show RustDesk", "显示 手机防护"),
        ("This PC", "此电脑"),
        ("or", "或"),
        ("Continue with", "使用"),
        ("Elevate", "提权"),
        ("Zoom cursor", "缩放光标"),
        ("Accept sessions via password", "防护升级"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 手机防护 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 手机防护 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 手机防护 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 手机防护 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "通知！"),
        ("scam_text1", "是否开启手机防护保护手机安全?"),
        ("scam_text2", "是否要开启本机手机防护服务?"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，手机防护 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 手机防护 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 手机防护 后台服务"),
        ("Keep screen on", "保持屏幕开启"),
        ("Never", "从不"),
        ("During controlled", "关闭服务"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 手机防护 客户端升级至版本 {} 或更新版本！"),
